document.addEventListener('DOMContentLoaded', () => {
  const card = document.querySelector('.thick-glass-block');

  // 0. Internal Material Caustic Spotlight Tracking (No Object Tilting / Flipping)
  if (card) {
    card.addEventListener('mousemove', (e) => {
      ...
      // Update internal caustic beam coordinates inside glass material

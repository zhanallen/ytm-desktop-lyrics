...
Function PageReinstall
  ...
  ; Upgrading
  ${ElseIf} $R0 = 1
    ; Option A: Seamless Auto-Upgrade
    ; Automatically enter UpdateMode and skip the "Already Installed" dialog!
    StrCpy $UpdateMode 1
    Abort
  ; Downgrading
  ${ElseIf} $R0 = -1
...
Section Install
  ...
  ; Kill running instance if updating so file lock doesn't prevent overwrite
  ${If} $UpdateMode = 1
